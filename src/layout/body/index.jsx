...
import FollowedManga from "../../pages/follows/followedMangas";
import FollowedUser from "../../pages/follows/followedUsers";
  ...
  return (
    <div id="main-content">
      <Routes>
        ...
        <Route path="/followed-users" element={<FollowedUser />} />
