                    ...
                    <div className="Auth-form-content">
                        ...
                        <div className="form-group mt-3">
                            ...
                            <InputGroup className="mb-3">
                                ...
                                <Form.Control value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" aria-label="Username" />
                            </InputGroup>
                        </div>
                        <div className="form-group mt-3">
                        ...
                        <div className="d-grid gap-2 mt-3">
                            <Button variant="danger" className="mb-4 w-100" onClick={() => handleLogin()}>
